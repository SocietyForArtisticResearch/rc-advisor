...
var $author$project$Main$init = $author$project$Main$NotExist;
		...
		switch (model.$) {
			case 'NotExist':
				return $author$project$Main$renders(
					_List_fromArray(
						[
							$author$project$Main$txt('A user can create a new exposition by clicking: '),
							A2(
							...
							return $author$project$Main$block(
								_List_fromArray(
									[
										...
										$author$project$Main$txt('expositions can be connected to portals or groups, but they have to be shared first.')
									]));
						case 'ShareInPortal':
							return $author$project$Main$block(
								_List_fromArray(
									[
										A2(
										$author$project$Main$btn,
										$author$project$Main$txt('connection to portal'),
										$author$project$Main$AuthorMsg(
				...
				return $author$project$Main$renders(
					_List_fromArray(
						[
							...
							shareBlock,
							$author$project$Main$br,
							$author$project$Main$txt('It is also possible to publish an exposition, which fixes the contents and registers a DOI.'),
							A2(
							$author$project$Main$btn,
			...
			case 'InReview':
					...
					switch (_v8.$) {
						case 'Uncatagorized':
							return $author$project$Main$block(
								_List_fromArray(
									[
										$author$project$Main$txt('the exposition appears under \"Uncatagorized\"'),
										A2(
										$author$project$Main$btn,
				...
				return $author$project$Main$renders(
					_List_fromArray(
						[
							$author$project$Main$h('the exposition is now in review.'),
							$author$project$Main$List(
							_List_fromArray(
								[
									$author$project$Main$par(
									_List_fromArray(
										[
											$author$project$Main$p('The portal admin has been notified and the exposition is listed in '),
